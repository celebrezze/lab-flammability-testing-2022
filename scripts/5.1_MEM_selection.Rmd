...
pred_vec <- c('branching', 'dmc', 'leaf_mass_ratio', 'lfm', 'LMA', 'mpa', 'sample_wt', 'sample_wt:dmc', 'sample_wt:mpa', 'start_temp', 'start_temp:sample_wt', 'stem_sav')
...
coef <- c(0.188, NA, NA, NA, NA, -0.106, 0.431,
          NA, 0.133, 0.136, NA, -0.325, # fh
          NA, 0.368, 0.182, NA, NA, NA, 0.404,
          0.297, NA, NA, NA, NA, # fd
          0.207, NA, NA, -0.155, NA, NA, 0.111,
          NA, NA, -0.532, -0.305, NA, # temp
          NA, NA, NA, NA, -0.014, NA, 0.657,
          NA, NA, 0.241, -0.228, NA) # hf
...
ggplot(aes(x = predictors, y = flam_metrics, fill = coef)) +
  ...
  geom_vline(xintercept = 9.5, linewidth = 0.4, color = 'gray35', linetype = 'dashed') +
...
Branching:
```{r}
fh_mod <- lmer(fh ~ sample_wt*mpa + branching + start_temp + stem_sav + (1|species/plant_id), REML = F, data = mem.df) # remef is also sensitive to NAs

mem.df$r_fh <- remef(fh_mod, fix = c('sample_wt:mpa', 'mpa', 'sample_wt', 'start_temp', 'stem_sav'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between branching and flame height
...
Sample Weight:
```{r}
mem.df$r_fh <- remef(fh_mod, fix = c('mpa', 'branching', 'start_temp', 'stem_sav'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between sample weight and flame height
...
ggplot(mem.df, aes(x = sample_wt, y = r_fh))  +
  ...
  #stat_cor(label.y = 0.9)+ 
  #stat_regline_equation(label.y = 1.2) +
  labs(x = 'Sample Mass (scaled)', y = 'Flame Height', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
...
ggplot(aes(x = sample_wt, y = r_fh))  +
  ...
  stat_cor(label.y = 0.9)+ 
  stat_regline_equation(label.y = 1.2) +
  labs(x = 'Sample Weight (scaled)', y = 'Flame Height') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
...
Stem SAV:
```{r}
mem.df$r_fh <- remef(fh_mod, fix = c('sample_wt:mpa', 'mpa', 'sample_wt', 'start_temp', 'branching'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between lfm and flame height

# With REMEF
fh.sav.remef <- ggplot(mem.df, aes(x = stem_sav, y = r_fh))  +
  geom_point(aes(color = species), alpha = 0.8) +
  geom_smooth(method = 'lm', color = 'gray40') +
  #stat_cor(label.y = 0.9)+ 
  #stat_regline_equation(label.y = 1.2) +
  labs(x = 'Stem SA:V (scaled)', y = 'Flame Height', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
        legend.title = element_text(face = 'bold', size = 15))
fh.sav.remef
ggsave(here('figures', 'MEM_2', 'REMEF', 'stem_sav.vs.fh.png'), width = 8, height = 5.5)
...
MPa:
```{r}
mem.df$r_fh <- remef(fh_mod, fix = c('stem_sav', 'sample_wt', 'start_temp', 'branching'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between lfm and flame height

# With REMEF
fh.mpa.remef <- ggplot(mem.df, aes(x = mpa, y = r_fh))  +
  geom_point(aes(color = species), alpha = 0.8) +
  geom_smooth(method = 'lm', color = 'gray40') +
  #stat_cor(label.y = 0.9)+ 
  #stat_regline_equation(label.y = 1.2) +
  labs(x = 'Water Potential (scaled)', y = 'Flame Height', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
...
DMC:
```{r}
fd_mod <- lmer(fd ~ sample_wt*dmc + leaf_mass_ratio + (1|species/plant_id), data = mem.df, REML = F) # remef is also sensitive to NAs
summary(fd_mod)
...
ggplot(mem.df, aes(x = sample_wt, y = r_fd))  +
  ...
  labs(x = 'Sample Mass (scaled)', y = 'Flame Duration', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
...
Leaf mass ratio:
```{r}
mem.df$r_fd <- remef(fd_mod, fix = c('dmc', 'sample_wt', 'sample_wt:dmc'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between sample weight and flame duration
...
# Split by Species
mem.df %>%  filter(species != 'HETARB') %>% 
ggplot(aes(x = leaf_mass_ratio, y = r_fd))  +
  geom_point(alpha = 0.8, color = 'gray20') +
  geom_smooth(method = 'lm', color = 'gray40') +
  facet_wrap(~species, scales = 'free') +
  stat_cor(label.y = 0.9)+ 
  stat_regline_equation(label.y = 1.2) +
  labs(x = 'Leaf Mass Ratio (scaled)', y = 'Flame Duration (effects removed, scaled)') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
#ggsave(here('figures', 'MEM_2', 'REMEF', 'lmr.vs.fd.spp.png'), width = 8, height = 5.5)
```
...
LMA:
```{r}
hf_mod <- lmer(heat_flux_change ~ start_temp*sample_wt + LMA + (1|species/plant_id), data = mem.df, REML = F) # remef is also sensitive to NAs

mem.df$r_hf <- remef(hf_mod, fix = c('sample_wt', 'start_temp', 'start_temp:sample_wt'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between leaf mass ratio and heat flux change
...
hf.lma.remef <- ggplot(mem.df, aes(x = LMA, y = r_hf))  +
  ...
  theme(axis.title = element_text(face = 'bold', size = 16),
        ...
        legend.text = element_text(size = 13))
hf.lma.remef
ggsave(here('figures', 'MEM_2', 'REMEF', 'lma.vs.heatflux.png'), width = 8, height = 5.5)
...
ggplot(aes(x = LMA, y = r_hf))  +
  ...
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
#ggsave(here('figures', 'MEM_2', 'REMEF', 'lma.vs.heatflux.spp.png'), width = 8, height = 5.5)
```
...
Branching:
```{r}
temp_mod <- lmer(temp_change ~ start_temp*sample_wt + branching + lfm + (1|species/plant_id), data = mem.df, REML = F) # remef is also sensitive to NAs

mem.df$r_temp <- remef(temp_mod, fix = c('start_temp', 'sample_wt', 'start_temp:sample_wt', 'lfm'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between branching and temperature change
...
Sample weight:
```{r}
mem.df$r_temp <- remef(temp_mod, fix = c('start_temp', 'branching', 'lfm'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between sample mass and temperature change
...
ggplot(mem.df, aes(x = sample_wt, y = r_temp))  +
  ...
  labs(x = 'Sample Mass (scaled)', y = 'Temp. Change', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
...
ggplot(aes(x = sample_wt, y = r_temp))  +
  ...
  stat_cor(label.y = 1.9)+ 
  stat_regline_equation(label.y = 2.3) +
  labs(x = 'Sample Mass (scaled)', y = 'Temp. Change') +
  theme_bw() +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
...
Starting Temp.
```{r}
mem.df$r_temp <- remef(temp_mod, fix = c('branching', 'sample_wt', 'lfm'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between starting temperature and temperature change
...
ggplot(mem.df, aes(x = start_temp, y = r_temp))  +
  ...
  labs(x = 'Starting Temp. (scaled)', y = 'Temp. Change', color = 'Species') +
  theme_bw() +
  scale_color_manual(values = c("#ED0000B2", "#42B540B2", "#0099B4B2", "#AD002AB2", "#ADB6B6B2", "#1B1919B2")) +
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12),
...
LFM:
```{r}
mem.df$r_temp <- remef(temp_mod, fix = c('start_temp', 'sample_wt', 'start_temp:sample_wt', 'branching'), ran = "all", keep.intercept = FALSE) # w/ remef, we are removing the above fixed effects and all of the random effects (i.e., '(1|species/plant_id)' for this selection) to isolate the relationship between LMA and temperature change
...
temp.lfm.remef <- ggplot(mem.df, aes(x = lfm, y = r_temp))  +
  ...
  theme(legend.title = element_text(face = 'bold', size = 15),
        ...
        axis.text = element_text(size = 12))
temp.lfm.remef
ggsave(here('figures', 'MEM_2', 'REMEF', 'lfm.vs.temp.png'), width = 8, height = 5.5)
...
ggplot(aes(x = lfm, y = r_temp))  +
  ...
  theme(axis.title = element_text(face = 'bold', size = 15),
        axis.text = element_text(size = 12))
#ggsave(here('figures', 'MEM_2', 'REMEF', 'lfm.vs.temp.spp.png'), width = 8, height = 5.5)
```

## Arranged
```{r}
ggarrange(fd.dmc.remef, fd.lmr.remef, fh.sav.remef, fh.mpa.remef, temp.lfm.remef, hf.lma.remef,
          labels = c('a', 'b', 'c', 'd', 'e', 'f'), 
          font.label = list(size = 28),
          ncol = 3, nrow = 2,
          common.legend = T)
ggsave(here('figures', 'MEM_2', 'remef.scatterplots.png'), height = 8, width = 14)
```

# Remef for Conceptual Plots
```{r}
# data wrangling
conceptual.mem.df <- flamm.df %>% 
  filter(ignition != '0') %>% 
  unite('plant_id', c(species, plant), sep = '_', remove = F) %>% 
...
# models
fh_mod <- lmer(fh ~ sample_wt*mpa + branching + start_temp + stem_sav + (1|species/plant_id), REML = F, data = conceptual.mem.df) # remef is also sensitive to NAs
fd_mod <- lmer(fd ~ sample_wt*dmc + leaf_mass_ratio + (1|species/plant_id), data = conceptual.mem.df, REML = F) # remef is also sensitive to NAs
hf_mod <- lmer(heat_flux_change ~ start_temp*sample_wt + LMA + (1|species/plant_id), data = conceptual.mem.df, REML = F) # remef is also sensitive to NAs
temp_mod <- lmer(temp_change ~ start_temp*sample_wt + branching + lfm + (1|species/plant_id), data = conceptual.mem.df, REML = F) # remef is also sensitive to NAs

# remef
conceptual.mem.df$r_fh <- remef(fh_mod, fix = c('sample_wt'), ran = "all", keep.intercept = FALSE)
conceptual.mem.df$r_fd <- remef(fd_mod, fix = c('sample_wt'), ran = "all", keep.intercept = FALSE)
conceptual.mem.df$r_temp_change <- remef(temp_mod, fix = c('sample_wt'), ran = "all", keep.intercept = FALSE)
conceptual.mem.df$r_heat_flux_change <- remef(hf_mod, fix = c('sample_wt'), ran = "all", keep.intercept = FALSE)

# dataframe
conceptual.mem.df <- conceptual.mem.df %>% 
  select(species, ignition, prop_ig, fh, fd, temp_change, heat_flux_change, r_fh, r_fd, r_temp_change, r_heat_flux_change, plant_id)
write.csv(conceptual.mem.df, here('data', 'processed-data', 'interspecific_flam_remef.csv'))
```
